...
public class FeedRecylerAdapter extends RecyclerView.Adapter<FeedRecylerAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        Picasso.get().load(userEmailList.get(position)).into(holder.imageView);

    }

    @Override
    public int getItemCount() { //Recylerview da kaç tane row olacak onu yazıcaz
        return userEmailList.size(); // diğerlerinin de size ını verebilirdik.
    }
